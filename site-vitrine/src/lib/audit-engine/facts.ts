  ...
  if (onePage && facts.services.length >= 2) {
    ...
    cards.push(
      card({
        ...
        axis: "trouve",
        title: "Un seul point d’entrée pour tous vos services",
        score: 3,
        ...
        loss: `Une personne qui cherche précisément « ${names[0]}${where} » a peu de chances de tomber sur une page qui répond exactement à sa recherche.`,
        potentialText: "Une page par service donnerait à chaque recherche précise une page qui y correspond.",
    ...
    if (target && facts.pagesAnalyzed >= 2) {
      ...
      cards.push(
        card({
          ...
          axis: "trouve",
          title: `Visibilité du service « ${target.label} »`,
          score,
          ...
          loss: `Des prospects qui cherchent « ${target.label}${where} » peuvent trouver un concurrent plus explicite avant de vous découvrir.`,
          potentialText: "Une page dédiée permettrait de correspondre aux recherches de prospects déjà intéressés par ce service.",
  ...
  if (city && facts.localPages.length === 0 && !facts.homeTitleNamesCity && facts.homeTitle) {
    cards.push(
      card({
        ...
        axis: "trouve",
        title: `Votre zone (${city}) n’est pas mise en avant`,
        ...
        loss: `Pour une recherche « ${trade || "votre métier"} ${city} », d’autres entreprises qui affichent la ville peuvent sembler plus pertinentes que vous.`,
        potentialText: "Afficher clairement la zone aide les prospects locaux à comprendre tout de suite que vous intervenez chez eux.",
  ...
  if (p.realisationsPage && !p.homeProofMarkers.length && (p.realisationsImages ?? 0) >= 3) {
    cards.push(
      card({
        ...
        loss: "Un visiteur qui compare plusieurs artisans peut partir avant d’avoir vu la preuve que vous faites du bon travail.",
    ...
    cards.push(
      card({
        id: "chosen_no_proof",
        axis: "choisi",
        title: "Peu de preuves visibles avant de vous contacter",
        score: 3,
        ...
        loss: "Face à un concurrent qui montre ses chantiers et ses avis, un prospect peut hésiter à vous confier ses travaux.",
    ...
    cards.push(
      card({
        ...
        axis: "choisi",
        title: "Vos avis arrivent après la demande de devis",
        score: 6,
        ...
        loss: "Le prospect est invité à vous contacter avant d’avoir vu ce qui prouve votre sérieux.",
  ...
  if (p.certifications.length > 0 && p.certificationsOnHome.length === 0 && p.certificationPage) {
    cards.push(
      card({
        ...
        axis: "choisi",
        title: `Votre ${p.certifications[0]} est caché`,
        score: 5,
    ...
    cards.push(
      card({
        ...
        axis: "choisi",
        title: "Aucun label visible sur un service à aides",
        score: 4,
  ...
  if (c.phone && c.homeTelLinks === 0) {
    cards.push(
      card({
        ...
        loss: "Sur mobile, le prospect doit recopier votre numéro : une partie peut abandonner ou appeler le concurrent suivant, joignable en un geste.",
    ...
    cards.push(
      card({
        id: "contact_no_phone",
        axis: "contacte",
        title: "Aucun numéro de téléphone visible",
        score: 3,
        ...
        loss: "Pour une fuite, une panne ou un chantier urgent, le prospect appelle l’entreprise dont le numéro s’affiche tout de suite.",
    ...
    cards.push(
      card({
        ...
        axis: "contacte",
        title: "Rien pour vous contacter en haut de page",
        score: 4,
        ...
        loss: "Un prospect décidé doit chercher comment vous joindre, alors qu’il est prêt à le faire tout de suite.",
  ...
  if (c.mainForm && c.mainForm.fieldCount >= 9) {
    cards.push(
      card({
        ...
        axis: "contacte",
        title: "Formulaire de devis trop long",
        score: 5,
        ...
        loss: "Chaque champ en plus peut faire abandonner une partie des visiteurs qui avaient commencé une demande.",
    ...
    cards.push(
      card({
        ...
        axis: "contacte",
        title: "Les demandes arrivent sans qualification",
        score: 6,
        ...
        loss: "Vous devez rappeler chaque contact pour savoir s’il est dans votre zone et votre métier, y compris ceux qui ne le sont pas.",
    ...
    cards.push(
      card({
        id: "contact_no_form",
        axis: "contacte",
        title: "Pas de formulaire de demande de devis",
        score: 4,
        ...
        loss: "Le prospect qui ne veut pas appeler doit rédiger un e-mail à froid, ce qui en décourage une partie.",
