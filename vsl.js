  ...
  var QUESTIONS = [
    ...
    },
    {
      ...
      options: [
        ...
        { value: 'become_top_performer', label: 'Je vends déjà, mais je veux passer un cap et devenir un vrai performeur de la vente' },
      ],
    },
    {
      key: 'q5',
      type: 'text',
      title: 'Si tu devenais un véritable performeur en vente et en closing, qu\'est-ce que tu voudrais être capable d\'accomplir ?',
